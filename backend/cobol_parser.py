...
# Note: For full ANTLR integration with a formal grammar,
# we would include more advanced parsing code here.
# This hybrid approach maintains compatibility with the existing system
# while moving toward more formal parsing techniques.
